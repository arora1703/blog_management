                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="{{url('admin/update_blog/'.$blog_data->blog_id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                <div class="col-md-12 d-flex mb-3">
                                    <div class="col ">
                                        <label for="blog_title" class="form-label">Blog Title</label>
                                        <input type="text" class="form-control @error('blog_title') is-invalid @enderror" name="blog_title" value="{{old('blog_title',$blog_data->blog_title)}}" id="blog_title"
                                    ...
                                    <div class="col ms-3">
                                        ...
                                        <select class="form-select mb-3 @error('category_id') is-invalid @enderror" name="category_id" aria-label="example">
                                            ...
                                            @foreach($category as $key => $category)
                                                <option value="{{$category->category_id}}" @selected(old('category_id') == $category->category_id) @selected(old('category_id') == $blog_data->category_id) >{{$category->category_name}}</option>
                                            @endforeach
                                        </select>
                                        @error('category_id')
                                        <span style="color:red;">{{ $message }}</span>
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    id="floatingTextarea" style="height: 150px;">{{old('description',$blog_data->description)}}</textarea>
                                ...
                                <div class="col-md-12 d-flex mb-3">
                                    ...
                                    <div class="col ms-3">
                                        ...
                                        <div class="form-check form-check-inline form-check-margin">
                                            ...
                                            value="1" {{($blog_data->status==1?'checked':'')}} >
                                            <label class="form-check-label" for="inlineRadio1">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="inlineRadio2"
                                            value="0"  {{($blog_data->status==0?'checked':'')}}>
