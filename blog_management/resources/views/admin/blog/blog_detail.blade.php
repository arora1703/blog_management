                                        ...
                                        @foreach($blogdata as $key => $value)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{url('blog_detail').'/'.$value->blog_id}}" class="btn btn-sm btn-info" title="View"><i class="fa fa-eye"></i></a>  
                                                    @if($value->user->id==session()->get('user_id'))
                                                    <a href="{{url('admin/edit_blog').'/'.$value->blog_id}}" class="btn btn-sm btn-warning" title="Edit"><i class="fa fa-pen-nib"></i></a>
                                                    <a href="{{url('admin/delete_blog').'/'.$value->blog_id}}" class="btn btn-sm btn-primary" title="Delete"><i class="fa fa-eraser"></i></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
